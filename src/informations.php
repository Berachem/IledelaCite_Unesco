      ...
      <div class='row'>
        ...
        <div class='card bg-dark' style='width: 18rem;'>
            ...
            <div class='card-body'>
              ...
              <a href='https://tickets.monuments-nationaux.fr/fr-FR/familles?site=2035140822090400170' <button type='button' class='btn btn-danger' href='https://exploreparis.com/fr/2776-palais-justice-paris.html'>".$info_reserve[$langue]."</button></a>
            </div>
        </div>
