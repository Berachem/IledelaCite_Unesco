...
?>
    ...
    <div class="description">
        <p>
            Vous trouverez sur cette pages les informations utiles pour vous aider à préparer votre visite sur l'Île telles que les horaires des monuments, le prix d'entrée et enfin les transports en commun à proximité.
        </p>
    </div>

 
    <div class="sous_titre">
        <h2 style="color: #f7af3e;"><i class="fas fa-clock"></i> Horaires</h2>
      ...
      <div class="row">
        <div class="card bg-dark" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <h6 class="card-subtitle mb-2 "><i class="fas fa-hourglass-start" style="color: orange;"></i> Suspendue (Covid et travaux)</h6>
