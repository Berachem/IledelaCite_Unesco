      ...
      <div class='carousel-inner'>
        ...
        <div class='carousel-item'>
          ...
          <div class='carousel-caption'>
            ...
            <a target="_self" href='notredame.php<?php echo '?lang='.$langue ?>' ><button type='button' class='btn btn-primary'><i class='fas fa-arrow-right'></i> <?php echo $index_carousel_Yaller[$langue] ?></button></a>
          </div>
        </div>
        ...
        <div class='carousel-item'>
          ...
          <div class='carousel-caption'>
            ...
            <a target="_self" href='saintechapelle.php<?php echo '?lang='.$langue ?>' ><button type='button' class='btn btn-primary'><i class='fas fa-arrow-right'></i> <?php echo $index_carousel_Yaller[$langue] ?></button></a>
          </div>
        </div>
        ...
        <div class='carousel-item'>
          ...
          <div class='carousel-caption'>
            ...
            <a target="_self" href='lesponts.php<?php echo '?lang='.$langue ?>'><button type='button' class='btn btn-primary'><i class='fas fa-arrow-right'></i> <?php echo $index_carousel_Yaller[$langue] ?></button></a>
          </div>
        </div>
